...
def test_get_remote_analysis_status_endpoint(monkeypatch) -> None:
    monkeypatch.setattr(
        ...
        lambda: {
            ...
            "sourceIndex": "kb-articles-source-index",
            "sourceIndexProtected": True,
            "metadataIndex": "kb-analysis-sync-state",
            "localMetadataIndex": "kb-analysis-local-sync-state",
            "localDocumentCounts": {
                "articles": 10,
                "chunks": 20,
                "edges": 30,
            ...
            "aliases": {
                "articles": {
                    "alias": "kb-analysis-articles",
                    "backingIndices": ["kb-analysis-articles-run-1"],
                    "documentCount": 10,
                },
                "chunks": {
                    "alias": "kb-analysis-article-chunks",
                    "backingIndices": ["kb-analysis-article-chunks-run-1"],
                    "documentCount": 20,
                },
                "edges": {
                    "alias": "kb-analysis-duplicate-edges",
                    "backingIndices": ["kb-analysis-duplicate-edges-run-1"],
                    "documentCount": 30,
                },
                "clusters": {
                    "alias": "kb-analysis-duplicate-clusters",
                    "backingIndices": ["kb-analysis-duplicate-clusters-run-1"],
                    "documentCount": 40,
                },
            },
            "latestPublishedRun": {
